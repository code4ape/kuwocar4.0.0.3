...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v3, p0, Lcom/baidu/platform/comapi/map/N;->m:Z

    iput-boolean v3, p0, Lcom/baidu/platform/comapi/map/N;->n:Z
    ...
    iput-object v0, p0, Lcom/baidu/platform/comapi/map/N;->a:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, Lcom/baidu/platform/comapi/map/N;->b:Landroid/widget/ImageView;
    ...
    invoke-direct {p0, v0}, Lcom/baidu/platform/comapi/map/N;->a(I)I

    move-result v0

    iput v0, p0, Lcom/baidu/platform/comapi/map/N;->l:I

    iget-object v0, p0, Lcom/baidu/platform/comapi/map/N;->a:Landroid/widget/ImageView;

    const-string v1, "main_topbtn_up.9.png"

    invoke-direct {p0, v0, v1}, Lcom/baidu/platform/comapi/map/N;->a(Landroid/view/View;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2}, Lcom/baidu/platform/comapi/map/N;->setOrientation(I)V

    new-instance v0, Landroid/widget/LinearLayout$LayoutParams;

    invoke-direct {v0, v4, v4}, Landroid/widget/LinearLayout$LayoutParams;-><init>(II)V

    invoke-virtual {p0, v0}, Lcom/baidu/platform/comapi/map/N;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    iget-object v0, p0, Lcom/baidu/platform/comapi/map/N;->a:Landroid/widget/ImageView;

    invoke-virtual {p0, v0}, Lcom/baidu/platform/comapi/map/N;->addView(Landroid/view/View;)V

    iget-object v0, p0, Lcom/baidu/platform/comapi/map/N;->b:Landroid/widget/ImageView;

    invoke-virtual {p0, v0}, Lcom/baidu/platform/comapi/map/N;->addView(Landroid/view/View;)V

    iput-boolean v2, p0, Lcom/baidu/platform/comapi/map/N;->n:Z
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-boolean v4, p0, Lcom/baidu/platform/comapi/map/N;->m:Z

    iput-boolean v4, p0, Lcom/baidu/platform/comapi/map/N;->n:Z
    ...
    iget-object v1, p0, Lcom/baidu/platform/comapi/map/N;->h:Landroid/graphics/Bitmap;

    invoke-virtual {v0, v1}, Landroid/widget/ImageView;->setImageBitmap(Landroid/graphics/Bitmap;)V

    iget-object v0, p0, Lcom/baidu/platform/comapi/map/N;->b:Landroid/widget/ImageView;

    iget-object v1, p0, Lcom/baidu/platform/comapi/map/N;->j:Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, v4}, Lcom/baidu/platform/comapi/map/N;->setOrientation(I)V
    ...
    invoke-virtual {p0, v3}, Lcom/baidu/platform/comapi/map/N;->setOrientation(I)V
...
.method private a(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, v0}, Lcom/baidu/platform/comapi/AssetsLoadUtil;->loadAssetsFile(Ljava/lang/String;Landroid/content/Context;)Landroid/graphics/Bitmap;
...
.method private a(Landroid/view/View;Ljava/lang/String;)V
    ...
    iget v0, p0, Lcom/baidu/platform/comapi/map/N;->l:I

    iget v1, p0, Lcom/baidu/platform/comapi/map/N;->l:I

    iget v2, p0, Lcom/baidu/platform/comapi/map/N;->l:I

    iget v3, p0, Lcom/baidu/platform/comapi/map/N;->l:I
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, p0, Lcom/baidu/platform/comapi/map/N;->i:Landroid/graphics/Bitmap;
    ...
    iget-object v1, p0, Lcom/baidu/platform/comapi/map/N;->k:Landroid/graphics/Bitmap;
