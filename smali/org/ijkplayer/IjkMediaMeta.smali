.class public Lorg/ijkplayer/IjkMediaMeta;
...
# instance fields
.field public mAudioStream:Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;
...
.field public mVideoStream:Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/ijkplayer/IjkMediaMeta;->mStreams:Ljava/util/ArrayList;

    return-void
.end method

.method public static parse(Landroid/os/Bundle;)Lorg/ijkplayer/IjkMediaMeta;
    .locals 10
    ...
    :cond_0
    new-instance v2, Lorg/ijkplayer/IjkMediaMeta;

    invoke-direct {v2}, Lorg/ijkplayer/IjkMediaMeta;-><init>()V

    iput-object p0, v2, Lorg/ijkplayer/IjkMediaMeta;->mMediaMeta:Landroid/os/Bundle;

    const-string v1, "format"

    invoke-virtual {v2, v1}, Lorg/ijkplayer/IjkMediaMeta;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, v2, Lorg/ijkplayer/IjkMediaMeta;->mFormat:Ljava/lang/String;

    const-string v1, "duration_us"

    invoke-virtual {v2, v1}, Lorg/ijkplayer/IjkMediaMeta;->getLong(Ljava/lang/String;)J

    move-result-wide v4

    iput-wide v4, v2, Lorg/ijkplayer/IjkMediaMeta;->mDurationUS:J
    ...
    iput-wide v4, v2, Lorg/ijkplayer/IjkMediaMeta;->mStartUS:J
    ...
    iput-wide v4, v2, Lorg/ijkplayer/IjkMediaMeta;->mBitrate:J

    const-string v1, "video"

    invoke-virtual {v2, v1, v0}, Lorg/ijkplayer/IjkMediaMeta;->getInt(Ljava/lang/String;I)I
    ...
    invoke-virtual {v2, v1}, Lorg/ijkplayer/IjkMediaMeta;->getParcelableArrayList(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    new-instance v6, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;

    invoke-direct {v6, v1}, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;-><init>(I)V

    iput-object v0, v6, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;->mMeta:Landroid/os/Bundle;

    const-string v0, "type"

    invoke-virtual {v6, v0}, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, v6, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;->mType:Ljava/lang/String;
    ...
    iput-object v0, v6, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;->mLanguage:Ljava/lang/String;

    iget-object v0, v6, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;->mType:Ljava/lang/String;
    ...
    iput-object v0, v6, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;->mCodecName:Ljava/lang/String;
    ...
    iput-object v0, v6, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;->mCodecProfile:Ljava/lang/String;
    ...
    iput-object v0, v6, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;->mCodecLongName:Ljava/lang/String;

    const-string v0, "bitrate"

    invoke-virtual {v6, v0}, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;)I

    move-result v0

    int-to-long v8, v0

    iput-wide v8, v6, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;->mBitrate:J
    ...
    iput v0, v6, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;->mWidth:I
    ...
    iput v0, v6, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;->mHeight:I
    ...
    iput v0, v6, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;->mFpsNum:I
    ...
    iput v0, v6, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;->mFpsDen:I
    ...
    iput v0, v6, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;->mTbrNum:I
    ...
    iput v0, v6, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;->mTbrDen:I
    ...
    iput v0, v6, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;->mSarNum:I
    ...
    iput v0, v6, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;->mSarDen:I

    if-ne v3, v1, :cond_3

    iput-object v6, v2, Lorg/ijkplayer/IjkMediaMeta;->mVideoStream:Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;

    :cond_3
    :goto_2
    iget-object v0, v2, Lorg/ijkplayer/IjkMediaMeta;->mStreams:Ljava/util/ArrayList;
    ...
    iput v0, v6, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;->mSampleRate:I

    const-string v0, "channel_layout"

    invoke-virtual {v6, v0}, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;->getLong(Ljava/lang/String;)J

    move-result-wide v8

    iput-wide v8, v6, Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;->mChannelLayout:J

    if-ne v4, v1, :cond_3

    iput-object v6, v2, Lorg/ijkplayer/IjkMediaMeta;->mAudioStream:Lorg/ijkplayer/IjkMediaMeta$IjkStreamMeta;
...
.method public getDurationInline()Ljava/lang/String;
    ...
    iget-wide v0, p0, Lorg/ijkplayer/IjkMediaMeta;->mDurationUS:J
...
.method public getInt(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, p1, v0}, Lorg/ijkplayer/IjkMediaMeta;->getInt(Ljava/lang/String;I)I
...
.method public getInt(Ljava/lang/String;I)I
    ...
    invoke-virtual {p0, p1}, Lorg/ijkplayer/IjkMediaMeta;->getString(Ljava/lang/String;)Ljava/lang/String;
...
.method public getLong(Ljava/lang/String;)J
    ...
    invoke-virtual {p0, p1, v0, v1}, Lorg/ijkplayer/IjkMediaMeta;->getLong(Ljava/lang/String;J)J
...
.method public getParcelableArrayList(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Lorg/ijkplayer/IjkMediaMeta;->mMediaMeta:Landroid/os/Bundle;
